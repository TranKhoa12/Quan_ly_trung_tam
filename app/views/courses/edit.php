...
<?= pageHeader(
    'Chỉnh sửa khóa học', 
    'Cập nhật thông tin khóa học: ' . htmlspecialchars($course['course_name']),
        ...
        <div class="col-lg-8">
            <div class="stats-card">
                <div class="card-body">
                    ...
                    <form method="POST" action="/Quan_ly_trung_tam/public/courses/<?= $course['id'] ?>/update">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control" name="duration" min="1" 
                                       value="<?= htmlspecialchars($course['duration_hours'] ?? '') ?>">
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <select class="form-select" name="status">
                                    ...
                                    <option value="completed" <?= $course['status'] === 'completed' ? 'selected' : '' ?>>Đã hoàn thành</option>
                                </select>
                            </div>
...
// Render layout
useModernLayout('Chỉnh sửa khóa học', $content);
?>
